...
Matrix mat_mul(Matrix a, Matrix b) {
    ...
    for (int m=0; m < res.row - 4; m += 4) {
        ...
        for (int s = 0; s < res.col; s++) {
            res.data[(m+1) * res.col + s] = 0;
            __m128 new_c = _mm_load_ps(C);
            for (int n = 0; n < a.col - 4 ; n = n + 4) {
                float A[4] = {a.data[(m+1) * a.col + n], a.data[(m+1) * a.col + n + 1], a.data[(m+1) * a.col + n + 2], a.data[(m+1) * a.col + n + 3]};
                float B[4] = {b.data[n * b.col + s],b.data[(n+1)* b.col + s],b.data[(n+2) * b.col + s],b.data[(n+3) * b.col + s]};
            ...
            for (int n = a.col / 4 * 4; n < a.col; n++) {
                res.data[(m+1) * res.col + s] += a.data[(m+1) * a.col + n] * b.data[n * b.col + s];
            }
            // if( res.data[m * res.col + s] == 0)
            //     printf("%d %d %d\n",m ,s);
        }
        for (int s = 0; s < res.col; s++) {
            res.data[(m+2) * res.col + s] = 0;
            __m128 new_c = _mm_load_ps(C);
            for (int n = 0; n < a.col - 4 ; n = n + 4) {
                float A[4] = {a.data[(m+2) * a.col + n], a.data[(m+2) * a.col + n + 1], a.data[(m+2) * a.col + n + 2], a.data[(m+2) * a.col + n + 3]};
                float B[4] = {b.data[n * b.col + s],b.data[(n+1)* b.col + s],b.data[(n+2) * b.col + s],b.data[(n+3) * b.col + s]};
            ...
            for (int n = a.col / 4 * 4; n < a.col; n++) {
                res.data[(m+2) * res.col + s] += a.data[(m+2) * a.col + n] * b.data[n * b.col + s];
            }
            // if( res.data[m * res.col + s] == 0)
            //     printf("%d %d %d\n",m ,s);
        }
        for (int s = 0; s < res.col; s++) {
            res.data[(m+3) * res.col + s] = 0;
            __m128 new_c = _mm_load_ps(C);
            for (int n = 0; n < a.col - 4 ; n = n + 4) {
                float A[4] = {a.data[(m+3) * a.col + n], a.data[(m+3) * a.col + n + 1], a.data[(m+3) * a.col + n + 2], a.data[(m+3) * a.col + n + 3]};
                float B[4] = {b.data[n * b.col + s],b.data[(n+1)* b.col + s],b.data[(n+2) * b.col + s],b.data[(n+3) * b.col + s]};
            ...
            for (int n = a.col / 4 * 4; n < a.col; n++) {
                res.data[(m+3) * res.col + s] += a.data[(m+3) * a.col + n] * b.data[n * b.col + s];
            }
            // if( res.data[m * res.col + s] == 0)
            //     printf("%d %d %d\n",m ,s);
        }
    }
    for (int m= res.row /4 * 4; m < res.row; m++) {
        for (int s = 0; s < res.col; s++) {
            res.data[m * res.col + s] = 0;
            __m128 new_c = _mm_load_ps(C);
            for (int n = 0; n < a.col - 4 ; n = n + 4) {
...
void normalize(Matrix res) {
    ...
    for (int m=0; m < res.row - 4; m += 4) {
        ...
        for (int s = res.col / 4 * 4; s < res.col; s++){
            sum += res.data[(m+1) * res.col + s];
        }
        for (int s = 0; s < res.col; s++) 
            res.data[(m+1) * res.col + s] = res.data[(m+1) * res.col + s] / sum;
        ...
        for (int s = res.col / 4 * 4; s < res.col; s++){
            sum += res.data[(m+2) * res.col + s];
        }
        for (int s = 0; s < res.col; s++) 
            res.data[(m+2) * res.col + s] = res.data[(m+2) * res.col + s] / sum;
        ...
        for (int s = res.col / 4 * 4; s < res.col; s++){
            sum += res.data[(m+3) * res.col + s];
        }
        for (int s = 0; s < res.col; s++) 
            res.data[(m+3) * res.col + s] = res.data[(m+3) * res.col + s] / sum;
